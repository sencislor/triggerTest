...
class PPSD(object):
    ...
    def __init__(self, stats, metadata, skip_on_gaps=False,
        ...
        * Providing a dictionary containing poles and zeros information. Be
        ...
        if self.special_handling not in (None, "ringlaser", "hydrophone","convert"):
    ...
    def __process(self, tr):
        ...
        # special_handling "convert" does converting velocity
        # to acceleration data
        elif self.special_handling == "convert":
            # in case of rotational data just remove sensitivity
            spec /= self.metadata['sensitivity'] ** 2
    ...
    def plot(self, filename=None, show_coverage=True, show_histogram=True,
             ...
             max_percentage=None, period_lim=(0.01, 179), 
             show_mode=False, mode_linewidth=1, mode_color=None,
        ...
        if show_mode:
            ...
            if mode_color == None:
                if cmap.name == "viridis":
                    ...
                    color = mode_color
            ax.plot(xdata, mode_, color=color, zorder=9, linewidth=mode_linewidth)
